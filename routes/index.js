...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Royalty App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Royalty App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Royalty App Login', user : req.user }); 
}); 
